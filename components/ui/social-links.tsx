            ...
            return (
              ...
              >
                <a
                  ...
                  aria-label={`Visit ${style.label} profile`}
                  className="flex items-center justify-between w-44 h-14 px-4 ml-[-120px]
                             ...
                             bg-[hsl(var(--card))] shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black"
                >
                  {/* Gradient Overlay */}
                  <div
        ...
        <div className="lg:hidden fixed bottom-6 right-6 z-50">
          ...
          <div className="relative">
            ...
            <button
              ...
              aria-label={mobileDockOpen ? "Close social links menu" : "Open social links menu"}
